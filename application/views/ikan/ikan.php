<div class="col-md-12">
  <div class="row">
    <div class="col-md-12">
          <a class="btn btn-outline-primary" role="button" href="Ikan/tambah">
  ...
  <div class="table-responsive" style="border-top: 2px solid #6c757d; margin-top: 10px; padding-top: 10px;">
  	...
  	<table class="table table-striped table-hover" id="tabel">
        ...
        <th>Opsi</th>
  		...
  		<tbody>
  		<?php 
  		foreach ($dt_ikan->result() as $data){
            echo '
            <tr>
            <td>'.$data->kd_ikan.'</td>
            <td>'.$data->nm_ikan.'</td>
            ...
            <td>
              <a class="btn btn-outline-primary btn-sm" href="Ikan/edit/'.md5($data->kd_ikan).'" role="button" data-toggle="tooltip" data-placement="top" title="Hapus">
                  <i class="fa fa-edit"></i>
              </a>

              <a class="btn btn-outline-dark btn-sm" href="Ikan/delete/'.md5($data->kd_ikan).'" role="button" onclick="return confirm(\'Apakah Anda Ingin Menghapus Data Ini ??\')" 
