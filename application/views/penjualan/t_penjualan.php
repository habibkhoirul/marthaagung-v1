  ...
  <form clas="row" action="<?php echo base_url() ?>Penjualan/simpan" method="POST" name="simpanform" enctype="multipart/form-data"">
      ...
      <div class="form-group row">
        ...
        <div class="col-md-8 col-sm-10">
          <input type="text" class="form-control" id="no_jual" name="no_jual" value="<?php echo $no_jual ?>" readonly>
        </div>
      </div>
...
<div class="col-md-6">
  ...
  <div class="form-group row">
      <label for="tgl_jual" class="col-md-4 col-sm-2 col-form-label">Tanggal</label>
      <div class="col-md-8 col-sm-10">
        <input type="date" class="form-control" id="tgl_now" name="tgl_jual" required readonly>
      </div>
  </div>
  ...
  <div class="col-md-4">
    ...
    <div class="form-group row">
      ...
      <div class="col-md-9 col-sm-10">
        <input type="text" class="form-control" id="produk" name="produk" placeholder="Produk" required readonly>
      </div>
    </div>
