<?php
$koneksidb = mysqli_connect("localhost","root","","habibmart");
...
<table class="table-list" width="430" border="0" cellspacing="0" cellpadding="2">
  <tr>
    <td height="87" colspan="5" align="center">
        ...
        <center>Tuban</center> </td>
  </tr>
  <tr>
    <td colspan="5" align="right"><strong>Nota Penjualan</strong></td>
  </tr>
  <tr>
...
$notaSql = "SELECT detail_penjualan.*, produk.nm_produk
            FROM detail_penjualan 
            INNER JOIN produk ON detail_penjualan.kd_produk = produk.kd_produk
            WHERE no_penjualan='$noNota'";
