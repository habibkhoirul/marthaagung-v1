<?php 
  foreach ($dt_pembelian->result() as $dt) { 
    $no_beli = $dt->no_pembelian;
    $kd_petugas = $dt->kd_petugas;
    $tanggal = $dt->tgl_pembelian;
    $total = $dt->total;
...
<div class="col-md-12 row" style="margin-bottom: 30px;">
  <div class="col-md-10">
    <h3>
      <center>
      <i class="fas fa-shopping-cart"></i> Detail Transaksi Pembelian
      </center>
    </h3>
  </div>
  <div class="col-md-2">
  ...
  <form clas="row" action="<?php echo base_url() ?>Pembelian/simpan" method="POST" name="simpanform" enctype="multipart/form-data"">
      ...
      <div class="form-group row">
        ...
        <div class="col-md-8 col-sm-10">
          <input type="text" class="form-control" id="no_beli" value="<?php echo $no_beli ?>" readonly>
        </div>
      </div>
