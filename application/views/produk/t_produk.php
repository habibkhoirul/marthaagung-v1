...
<div class="col-md-12" style="margin-bottom: 30px;">
  <h3>
    <center>
    <i class="fas fa-gift"></i> <?php echo $mode?> Data Produk
    </center>
  </h3>
</div>
...
<form clas="row" action="<?php echo base_url() ?>Produk/simpan" method="POST" name="simpanform" enctype="multipart/form-data"">

    <div class="form-group row">
      <label for="kdproduk" class="col-md-2 col-sm-2 col-form-label">ID Produk</label>
      <div class="col-md-2 col-sm-10">
        <input type="text" class="form-control" id="kdproduk" name="kdproduk" value="<?php echo $kdproduk ?>" readonly>
        <input type="hidden" name="mode" value="<?php echo $mode ?>">
      </div>
    </div>

  <div class="form-group row">
    <label for="nama" class="col-md-2 col-sm-2 col-form-label">Nama Produk</label>
  ...
  <div class="alert alert-info">
    ...
    <ul>
      ...
      <li>Jika tidak ingin mengganti gambar, kosongi gambar produk!!</li>
      <?php } else { ?>
  ...
  <div class="form-group row">
    <label for="gambar" class="col-md-2 col-sm-2 col-form-label">Gambar Produk</label>
    <div class="col-md-6 col-sm-10">
  ...
  <div class="form-group" style="width: 100%;border-top: 1px solid #6c757d; padding: 5px;">
    ...
    <div class="btni" style="float: right;">
      ...
      <a role="button" class="btn btn-danger btn-batal" href="<?php echo base_url()?>Produk" onclick="return confirm('Apakah Anda Yakin Akan Membatalkan?\nData Yang Diinputkan Tidak Akan Diproses!!');">
        Batal
      </a>
    </div>
  </div>
